  ...
  theme: {
    extend: {
      colors: {
        ...
        // ── Semantic tokens (were referenced everywhere but never defined,
        //    which made modals/overlays render transparent with unreadable text).
        //    Mapped to CSS variables so they adapt to light/dark. ──
