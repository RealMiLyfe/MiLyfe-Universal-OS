...
export function ReportButton({ resourceType, resourceId, compact }: ReportButtonProps) {
 ...
 <div
 className="w-full max-w-md bg-white rounded-xl border border-gray-100 shadow-xl p-6 animate-slide-up"
 onClick={(e) => e.stopPropagation()}
 role="dialog"
 aria-label="Report content"
 >
 <div className="flex items-center justify-between mb-4">
 <h2 className="text-lg font-bold text-harbor-800 ">Report Content</h2>
 <button
 ...
 <div>
 <label className="block text-sm font-medium text-harbor-800 mb-2">
 What&apos;s the issue?
 </label>
 ...
 />
 <span className="text-sm text-harbor-800 ">{label}</span>
 </label>
 ))}
 </div>
 </div>
 ...
 <div>
 <label htmlFor="report-details" className="block text-sm font-medium text-harbor-800 mb-1">
 ...
 maxLength={500}
 rows={3}
 className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 resize-none"
 />
 </div>
