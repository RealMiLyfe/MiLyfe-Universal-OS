...
export function NotificationBell() {
 ...
 className="relative flex items-center justify-center h-10 w-10 rounded-lg hover:bg-gray-100 transition-colors"
 ...
 {open && (
 <div
 className="absolute right-0 top-12 w-80 sm:w-96 max-h-[70vh] overflow-hidden rounded-xl border border-gray-100 bg-white shadow-xl z-50 animate-slide-up"
 role="dialog"
 aria-label="Notifications"
 >
 {/* Header */}
 <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 ">
 <h2 className="text-sm font-bold text-harbor-800 ">Notifications</h2>
 ...
 className="h-6 w-6 flex items-center justify-center rounded hover:bg-gray-100 min-h-0 min-w-0"
 ...
 >
 <div className={cn('mt-0.5 p-1.5 rounded-lg bg-gray-50 ', color)}>
 <Icon className="h-3.5 w-3.5" aria-hidden="true" />
 </div>
 <div className="flex-1 min-w-0">
 <div className="flex items-start justify-between gap-2">
 <p className={cn('text-sm truncate', !notif.read ? 'font-semibold text-harbor-800 ' : 'text-gray-700 ')}>
 {notif.title}
 </p>
 {!notif.read && (
 <button
 onClick={() => markRead(notif.id)}
 className="shrink-0 h-5 w-5 flex items-center justify-center rounded hover:bg-gray-100 min-h-0 min-w-0"
