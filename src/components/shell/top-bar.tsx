    ...
    <header className="md:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-white dark:bg-harbor-950 border-b border-gray-100 dark:border-harbor-800">
      <div className="flex items-center justify-between h-full px-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            href="/profile"
            className="flex items-center justify-center h-8 w-8 rounded-full bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 text-[11px] font-bold ml-0.5"
