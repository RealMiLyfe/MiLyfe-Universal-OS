...
const ringMap = {
 teal: 'ring-2 ring-teal-400 ring-offset-2 ring-offset-white ',
 mly: 'ring-2 ring-mly-400 ring-offset-2 ring-offset-white ',
 harbor: 'ring-2 ring-harbor-400 ring-offset-2 ring-offset-white ',
 green: 'ring-2 ring-green-400 ring-offset-2 ring-offset-white ',
 none: '',
};
...
export function Avatar({ src, name, size = 'md', className, ring = 'none', status = 'none' }: AvatarProps) {
 ...
 <div
 className={cn(
 'rounded-full bg-teal-100 text-teal-700 font-bold flex items-center justify-center',
 sizeMap[size],
 ringMap[ring],
 className
 )}
