...
const buttonVariants = cva(
 ...
 outline: 'border border-gray-200 bg-white hover:bg-gray-50 text-harbor-800 ',
 secondary: 'bg-gray-100 text-harbor-800 hover:bg-gray-200 ',
 ghost: 'hover:bg-gray-100 text-harbor-800 ',
