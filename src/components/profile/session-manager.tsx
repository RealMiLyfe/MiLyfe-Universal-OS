...
export function SessionManager() {
 ...
 <h2 className="font-semibold text-harbor-800 flex items-center gap-2">
 ...
 <div>
 <p className="text-sm font-medium text-harbor-800 ">Sign out other devices</p>
 <p className="text-xs text-gray-500 ">Keep this session, sign out all others</p>
 </div>
 <Button
 variant="outline"
 size="sm"
 ...
 <div className="flex items-center justify-between gap-4 p-3 rounded-lg bg-gray-50 ">
 <div>
 <p className="text-sm font-medium text-harbor-800 ">Sign out everywhere</p>
 <p className="text-xs text-gray-500 ">Sign out on all devices including this one</p>
 </div>
 <Button
 variant="destructive"
 size="sm"
 ...
 <div>
 <p className="text-sm font-medium text-harbor-800 ">Change password</p>
 <p className="text-xs text-gray-500 ">Updates password and revokes other sessions</p>
 </div>
