...
export const alt = 'MiLyfe — Add Value. Raise Quality of Life.';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 48 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span style={{ fontSize: 36, fontWeight: 'bold', color: '#00C1AE' }}>Free</span>
            <span style={{ fontSize: 16, color: '#9fb8d9' }}>Forever</span>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span style={{ fontSize: 36, fontWeight: 'bold', color: '#ffffff' }}>Open</span>
            <span style={{ fontSize: 16, color: '#9fb8d9' }}>Source</span>
          </div>
        </div>
