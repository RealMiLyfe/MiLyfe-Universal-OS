...
export default function SignupPage() {
 ...
 <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-teal-50 text-teal-600 mx-auto">
 ...
 We sent a verification link to <span className="font-semibold text-harbor-900 ">{email}</span>. Please click the link to activate your account.
 </p>

 {resendStatus && (
 <p className="text-xs text-teal-600 bg-teal-50 p-2 rounded-lg">
 {resendStatus}
 </p>
 )}
 ...
 <div>
 <label htmlFor="username" className="block text-sm font-medium text-harbor-800 mb-1">
 Username
 </label>
 <Input
 id="username"
