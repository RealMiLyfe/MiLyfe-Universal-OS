  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        {error && (
          <div className="text-sm text-red-600 dark:text-red-400 p-3 bg-red-50 dark:bg-red-950/50 rounded-lg space-y-2" role="alert">
            <p>{error}</p>
            {unconfirmed && (
              <Button
                type="button"
        ...
        {resendStatus && (
          <p className="text-xs text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/50 p-2 rounded-lg text-center">
            {resendStatus}
          </p>
        )}
