    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="relative overflow-hidden rounded-xl p-5 bg-gradient-to-br from-harbor-50/80 to-harbor-100/40 dark:from-harbor-900/30 dark:to-harbor-800/10 border border-harbor-200/50 dark:border-harbor-700/30 backdrop-blur-sm">
          ...
          <p className="text-xs text-harbor-700/70 dark:text-harbor-400/70 font-medium uppercase tracking-wide mt-1">Verified Citizens</p>
        </div>
      </div>

      {/* How treasury grows */}
      <div className="rounded-xl border border-gray-100 dark:border-harbor-800 bg-white dark:bg-harbor-950/50 p-6">
        <h2 className="font-semibold text-harbor-800 dark:text-white mb-3">How the Treasury Operates</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Small fees on marketplace transactions flow back to replenish the community pool.</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <ArrowUpRight className="h-4 w-4 text-green-500 mt-0.5 shrink-0" aria-hidden="true" />
            <div>
              <p className="font-medium text-harbor-800 dark:text-white">Community Contributions</p>
              <p className="text-gray-500 dark:text-gray-400">Citizens contribute funds from their community pots toward shared initiatives.</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <ArrowDownLeft className="h-4 w-4 text-red-500 mt-0.5 shrink-0" aria-hidden="true" />
            <div>
              <p className="font-medium text-harbor-800 dark:text-white">Weekly UBI & Welcome Grants</p>
              <p className="text-gray-500 dark:text-gray-400">50 $MLY upon registration and 100 $MLY weekly to every verified citizen.</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <ArrowDownLeft className="h-4 w-4 text-red-500 mt-0.5 shrink-0" aria-hidden="true" />
            <div>
              <p className="font-medium text-harbor-800 dark:text-white">Steward & Learning Rewards</p>
              <p className="text-gray-500 dark:text-gray-400">Proposals (25 $MLY), attestations (10 $MLY), and path mastery (50 $MLY) are funded by the treasury.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-gray-100 dark:border-harbor-800 bg-white dark:bg-harbor-950/50 overflow-hidden">
        <div className="p-5 border-b border-gray-100 dark:border-harbor-800">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Every treasury movement is public and cryptographically traceable</p>
        </div>
