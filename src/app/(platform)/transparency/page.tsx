...
export default function TransparencyPage() {
 ...
 {/* Principles */}
 <div className="rounded-xl border border-teal-200 bg-gradient-to-r from-teal-50/50 to-white p-6">
 <h2 className="text-lg font-semibold text-harbor-800 flex items-center gap-2 mb-3">
 ...
 <h2 className="text-lg font-bold text-harbor-800 ">{title}</h2>
 </div>
 ...
 <td className="py-2 pr-4 font-medium text-gray-600 whitespace-nowrap">{label}</td>
 <td className="py-2 text-harbor-800 font-mono text-xs">{value}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <Link href="/treasury" className="rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-harbor-800 hover:bg-gray-50 transition-colors">
 <Users className="h-4 w-4 inline mr-1.5" aria-hidden="true" />
 Treasury Ledger
 </Link>
 <Link href="/governance" className="rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-harbor-800 hover:bg-gray-50 transition-colors">
 <Vote className="h-4 w-4 inline mr-1.5" aria-hidden="true" />
 View Proposals
 </Link>
 <a href="https://github.com/RealMiLyfe/MiLyfe-Universal-OS" target="_blank" rel="noopener noreferrer" className="rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-harbor-800 hover:bg-gray-50 transition-colors">
