...
export function AppsView({ apps }: Props) {
 ...
 <Card key={app.id} className="hover:border-teal-200 transition-colors">
 ...
 <h3 className="text-sm font-bold text-harbor-800 truncate">
 {app.name}
 </h3>
 ...
 <h3 className="font-bold text-harbor-800 mb-1">Build an App</h3>
