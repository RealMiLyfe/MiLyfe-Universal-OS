...
export default function GuidelinesPage() {
 ...
 <h2 className="font-bold text-harbor-800 flex items-center gap-2 mb-3">
 ...
 <h2 className="font-bold text-harbor-800 flex items-center gap-2 mb-4">
 <AlertTriangle className="h-5 w-5 text-orange-500" aria-hidden="true" />
 Enforcement
 </h2>
 <div className="space-y-3">
 {CONSEQUENCES.map(({ severity, description }) => (
 <div key={severity} className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 ">
 <span className="text-sm font-semibold text-harbor-800 whitespace-nowrap min-w-[160px]">{severity}</span>
