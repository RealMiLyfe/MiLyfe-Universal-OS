...
export function BountiesView() {
 ...
 <p className="text-2xl font-bold text-harbor-800 ">{totalBounties}</p>
 ...
 !filterDomain ? 'bg-teal-500 text-white' : 'bg-gray-100 text-gray-600 '
 }`}
 >
 All
 </button>
 ...
 className={`px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors min-h-[32px] ${
 filterDomain === d.key ? 'bg-teal-500 text-white' : 'bg-gray-100 text-gray-600 '
 }`}
 ...
 return (
 <Card key={bounty.id} className="hover:border-teal-200 transition-colors">
 ...
 <h3 className="text-sm font-bold text-harbor-800 ">
 {bounty.name}
 </h3>
 ...
 {/* Full roadmap link */}
 <Card className="bg-harbor-50 border-harbor-200 ">
 <CardContent className="py-6 text-center">
 <h3 className="font-bold text-harbor-800 mb-1">Full Roadmap</h3>
