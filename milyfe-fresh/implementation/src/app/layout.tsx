  ...
  return (
    <html lang="en">
      <body className="bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
        <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded-xl focus:bg-emerald-700 focus:p-3 focus:text-white">
          Skip to content
        </a>
        ...
        <main id="main" className="mx-auto max-w-2xl px-4 pb-24 pt-4">{children}</main>
        <Nav />
        <script
