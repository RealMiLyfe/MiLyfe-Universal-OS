...
- **Rails:** crypto in (USDC/USDT/SOL/BTC/ETH/XRP) + cash in via trusted nodes; out via community P2P swaps; own cards (digital NFC first, own-network plastic later). No GoCardless/Whop/Stripe/Visa-MC rails. USD-facing automation stays LOCKED until qualified review + human approval.
