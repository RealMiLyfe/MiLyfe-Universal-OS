...
- **States (nine labels, always shown):** projected (not real yet, never shown as balance) / pending / verified / settled / allocated / rewarded / reinvested / reserved / disputed / reversed.
- **Safeguards:** no-negative ever; provisional treasury circuit breaker (34%/48h/80% — opt-in only, not a constitutional rule); default issuance split 70% place / 30% commons; safety freeze; full export anytime, even in disputes.
- **Rails:** crypto in (USDC/USDT/SOL/BTC/ETH/XRP) + cash in via trusted nodes; out via community P2P swaps; own cards (digital NFC first, own-network plastic later). No GoCardless/Whop/Stripe/Visa-MC rails. USD-facing automation stays locked until risk/disclosure/partner review + evidence + human approval. Internal MLY activity is never gated on outside permission.
- **Doorways:** independent people/businesses that accept $MLY or cash out for the public follow MSB/MiCA/local rules themselves; MiLyfe listing is not operating.
- **Risks:** value depends on voluntary community acceptance; crypto assets are volatile; P2P meetings carry ordinary in-person risks (meet-public guidance + safety tools provided); tax duties are yours (exports provided).
