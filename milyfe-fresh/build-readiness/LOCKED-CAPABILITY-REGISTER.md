...
|---|---|---|---|
| L1 | USD-facing rails | design | U.S. legal + financial reviews, partners, reserves, consumer terms, fraud/sanctions controls, reconciliation, H |
| L2 | Reverse-$MLY redemption automation | design | same as L1 |
| L3 | Public exchange listing | design | community vote + legal review + H |
